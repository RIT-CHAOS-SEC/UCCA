...
// Defining uccmin and uccmax in memory for different regions.
uint16_t ucc1min __attribute__((section (".ucc1min"))) = 0xE216;
uint16_t ucc1max __attribute__((section (".ucc1max"))) = 0xE26E;
uint16_t ucc2min __attribute__((section (".ucc2min"))) = 0xE270;
uint16_t ucc2max __attribute__((section (".ucc2max"))) = 0xE2F4;
uint16_t ucc3min __attribute__((section (".ucc3min"))) = 0xEF00;
uint16_t ucc3max __attribute__((section (".ucc3max"))) = 0xEF26;
...
/* A dummy ISR that is stored within region two alongside the password comparison
*/
__attribute__ ((section (".regionTwo"))) ISR(PORT1,TCB){
	P1IFG &= ~P1IFG;
	P5OUT = ~P5OUT;
}
